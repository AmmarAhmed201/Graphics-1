...
def lose():
    global k, p, l,t, collsionBall, playAgain, numOfSplitings, initialHVelocity, initialvVelocity,images, initialRadius
    global y_weapon, x_weapon, x_char, y_char, anim, anim_squ, weapon, parameters, listt, timer
    global  LightSpec, LightDiff, LightPos, LightAmb, dtime, axrng, width, height
...
def Animation():
    ...
    global LightSpec,LightDiff,LightPos,LightAmb,dtime ,axrng ,width,height,timer
